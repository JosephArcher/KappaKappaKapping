...
class CreditReportPage extends React.Component {
  ...
  render() {
    ...
    // Get the Names of the top three majors
    ...
    // Get the percent complete of the top three majors
    ...
    // Get the Completed Coureses for each of the top three majors
    const Major1c                      = topThreeMajors[0].Completed_Courses;
    const Major2c                      = topThreeMajors[1].Completed_Courses;
    const Major3c                      = topThreeMajors[2].Completed_Courses;

    // Data used for the circle chart
    const testdata = [
      {
        value: testCalc,
        color: "#007fff",
        ...
        <div className="CreditReportPage-container">
          <Grid>
            ...
            <Row>
              ...
              <Col xs={12} md={12} lg={12}>
                <MajorItem majorTitle = {Major1} courseList={Major1c} majorPercent={Major1p}> </MajorItem>
                <MajorItem majorTitle = {Major2} courseList={Major2c} majorPercent={Major2p}> </MajorItem>
                <MajorItem majorTitle = {Major3} courseList={Major3c} majorPercent={Major3p}> </MajorItem>
              </Col>
            </Row>
          </Grid>
        </div>
